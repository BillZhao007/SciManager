#include <scirecommend/multi_input_dialog.h>

MultiInputDialog::MultiInputDialog(int count, bool num, QWidget *parent)
: QDialog(parent), m_GroupCount(count), MultiInputDialogFinish(true)
{
    QVBoxLayout *layout = new QVBoxLayout;
    QHBoxLayout *subLayout;

    QIntValidator* aIntValidator = new QIntValidator;
    aIntValidator->setRange(-100, 100);
    ...
    for(int i=0; i<m_GroupCount; i++)
    {
        ...
        if(num) m_LineEdits[i]->setValidator(aIntValidator);
    }
...
//void MultiInputDialog::accept() {
//    MultiInputDialogReturn = GetAllTexts();
//    hide();
//}

//void MultiInputDialog::reject() {hide();}
